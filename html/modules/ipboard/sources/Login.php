...
class Login
{
    ...
    {
        global $ibforums, $DB, $std, $HTTP_COOKIE_VARS, $xoopsConfig;
    ...
    public function do_log_in()
    {
        ...
        if ($DB->get_num_rows()) {
            ...
            header('location: ' . XOOPS_URL . '/user.php?op=login&uname=' . $_POST['UserName'] . "&pass=$pass");
...
'login_type' => $ibforums->input['Privacy'] ? 1 : 0,
    ...
    {
        global $std, $ibforums, $DB, $print, $sess, $HTTP_COOKIE_VARS, $xoopsConfig;
