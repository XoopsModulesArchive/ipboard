...
'set_id' => $new_id,
    ...
    public function macro_edit()
    {
        ...
        $key = str_replace("'", "\\'", stripslashes($_POST['macro_value']));

        $val = str_replace("'", "\\'", stripslashes($_POST['macro_replace']));
    ...
    public function macro_add()
    {
        ...
        $str = $DB->compile_db_insert_string(
            [
                'macro_value' => stripslashes($_POST['macro_value']),
'macro_replace' => stripslashes($_POST['macro_replace']),
'can_remove' => 1,
'macro_set' => $row['macro_set'],
    ...
    public function macro_form($type = 'edit')
    {
        global $IN, $INFO, $DB, $SKIN, $ADMIN, $std, $MEMBER, $GROUP;
...
4 => ['mid', $IN['mid']],
    ...
    public function add_macro_set()
    {
        ...
        while (false !== ($row = $DB->fetch_row($q1))) {
            $str = $DB->compile_db_insert_string(
                [
...
3 => ['id', $IN['id']],
            ...
            'theAdminForm',
            "onSubmit=\"return no_specialchars('images')\""
        );
        ...
        $SKIN->td_header[] = ['Macro Key', '20%'];

        $SKIN->td_header[] = ['Macro Replacement', '45%'];

        $SKIN->td_header[] = ['Preview', '15%'];
    ...
    public function list_current()
    {
        ...
        if ($DB->get_num_rows()) {
            ...
            while (false !== ($r = $DB->fetch_row())) {
                ...
                if (in_array($r['macro_set'], $used_ids, true)) {
                    continue;
                }
                ...
                $form_array[] = [$r['macro_set'], $r['set_name']];
            }
        ...
        if (count($used_ids) > 0) {
            ...
            if ($DB->get_num_rows()) {
                ...
                while (false !== ($r = $DB->fetch_row())) {
                    ...
                    $form_array[] = [$r['set_id'], $r['set_name']];
                }
