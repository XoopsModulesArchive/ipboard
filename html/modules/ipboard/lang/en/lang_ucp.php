...
'pp_use_default' => 'Use forum default',
    ...
    'mess_saved' => "Saved (Unsent) PM's",
'dst_box' => '<b>Is daylight savings time in effect?</b><br>(If you have selected the correct time zone and the clock appears<br>an hour out, check or uncheck box to suit)',
...
'avup_no' => 'You do not have an uploaded avatar stored, you may choose to upload an avatar by using the box above',
    ...
    'hide_session_txt' => "<b>Do you wish to hide your session id in the links?</b><br>(Note: Your computer must be able to receive temporary cookies to use this feature)<br>Choosing 'no' may cause problems when sharing links with people on the same proxy as you.",
...
'm_view_forum' => 'View Forums',
    ...
    'm_links' => 'Personal Links',
'm_edit_links' => 'Edit Links',

    'qc_header' => 'Quick Clicks',

    'qc_messenger' => 'Messenger',
'qc_inbox' => '|_ Inbox',
'qc_sent' => '|_ Sent Items',
'qc_compose' => '|_ Send Msg',
'qc_prefs' => '|_ Msg Prefs',

    'qc_search' => 'Search',
'qc_home' => 'Forum Home',
'qc_help' => 'Help',

    'qc_your_links' => 'Your links',
...
'ce_auth' => '<br><br>PLEASE NOTE: You will have to re-activate your account after changing your email address.<br>An email will be sent to the email address you specify below, outlining what you need to do.<br><br>Proceeding with this action will log you out. It is strongly recommended that you reset your password before changing your email address if you are unable to remember your password.',
    ...
    'upload_avatar' => '<u>OR</u> Upload an avatar',
...
no => 'No',
settings_time_txt => 'You may adjust the base time zone<br>The time (including your current adjustment) is:',
...
submit_email => 'Amend my email settings',
    ...
    'msg_options' => 'Options',
avatar_dims => '<b>Avatar Dimensions</b>',
avatar => '<b>Your avatar</b>',
subs_view => 'Views',
email_text_lp => 'Lost Password request at',
avatar_ops_txt => 'This is where you can choose your avatar to use when making a post. This is completely optional, but many members use them as a fun way to express themselves.',
...
subs => 'Topic Tracker',
current_avatar => 'Avatar Preview',
subs_deleted => 'The subscription has been deleted',
avatar_pre_submit => 'Add this avatar to my profile',
msn => '<b>Your MSN Messenger identity</b>',
avatar_sub => 'this is where you can choose to use an avatar under yourname when you post a message on these boards.',
registered => 'You registered on ',
avatar_url_submit => 'Add my own image as my avatar',
subs_by => 'By:',
...
$lang['time_4'] = '(GMT + 4:00 hours) Adu Dhabi, Baku, Muscat, Tbilisi';
